...
public class UserController {
	...
	public String login(User user) {
		...
		System.out.println(resPath+"1111111111111111");
		try {
			...
			System.out.println(resPath+"2222222222222222");
		} catch (IncorrectCredentialsException e) {
			// {ps} 密码错误..
			resPath = "redirect:/User/showLogin?errcode=2";
			System.out.println(resPath+"333333333333333333333");
		} catch (LockedAccountException e) {
			// {ps} 当前用户已锁定 ..
			resPath = "redirect:/User/showLogin?errcode=3";
			System.out.println(resPath+"4444444444444444444");
		}
		return resPath;
	}
